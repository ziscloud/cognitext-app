...
import {
    ...
    isLeftAlign,
    isLowercase,
    isOutdent, isPlainPaste, isPrint,
    isRightAlign, isSave,
    isStrikeThrough,
    isSubscript,
    isSuperscript,
...
import {PLAIN_PASTE_COMMAND} from "../PlainPastePlugin";
...
export default function ShortcutsPlugin({
    ...
    useEffect(() => {
        const keyboardShortcutsHandler = (event: KeyboardEvent) => {
            ...
            } else if (isPlainPaste(event)) {
                editor.dispatchCommand(PLAIN_PASTE_COMMAND, undefined);
            } else {
